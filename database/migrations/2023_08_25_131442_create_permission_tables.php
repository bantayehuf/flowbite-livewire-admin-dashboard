...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
            ...
            $table->string('guard_name');
            $table->unsignedBigInteger('for_department');
            $table->foreign('for_department')->references('id')->on('departments');
            $table->index('for_department', 'perm_roles_for_department_foreign');
