<x-app-layout>
    <h3 class="my-2 text-lg lg:text-xl font-bold tracking-tight text-gray-900 dark:text-white">
        My Profile
    </h3>
    ...
    <div class="grid grid-cols-12 md:grid--cols-2 gap-4 mb-4">
        <x-card
            ...
            <div class="flex flex-col items-center w-full">
                <img class="w-24 h-24 p-1 rounded-full ring-4 ring-secondary-500 dark:ring-gray-300"
