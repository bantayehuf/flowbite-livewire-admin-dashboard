<div>
    ...
    <form class="mt-6 col-span-4 w-full xl:w-3/4" wire:submit="updateProfileInformation" method="POST">
        @csrf
        ...
        <x-inputs.button-primary type="submit" class="mt-4" wire:target="updateProfileInformation">
            <x-spinner.inline class="mr-2" wire:target="updateProfileInformation" />
            {{ __('Change') }}
